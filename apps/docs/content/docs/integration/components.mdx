...
<Callout type="warn">
**Coming Soon.** `@recur/react` is currently in development. The components documented below represent the planned API. Use [`@recur/sdk`](/docs/sdk/quickstart) directly for now.
</Callout>
